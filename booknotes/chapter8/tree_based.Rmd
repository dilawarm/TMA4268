...
Carseats=data.frame(Carseats, High); Carseats$High = as.factor(Carseats$High)
```
...
These methods use trees as building blocks to build more complex models. Here we will use Boston housing data to explore random forests and boosting. These data are in the `MASS` package.
